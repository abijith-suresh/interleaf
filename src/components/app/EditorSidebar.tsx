    ...
    <aside class="w-56 border-r border-border flex-col flex-shrink-0 hidden md:flex">
      <div class="flex-1 overflow-y-auto min-h-0">
        ...
        <div class="p-4 border-b border-border">
          ...
          <button
            ...
            disabled={props.busy}
            class="w-full border border-dashed border-border hover:border-primary transition-colors py-6 text-center cursor-pointer bg-transparent disabled:cursor-not-allowed disabled:opacity-60"
          >
        ...
        <div class="p-4 border-b border-border">
          ...
          <button
            ...
            disabled={props.busy}
            class="w-full text-left text-xs text-body hover:text-primary hover:bg-hover bg-transparent border-none cursor-pointer py-2 px-2 transition-colors disabled:cursor-not-allowed disabled:opacity-60"
          >
            Select All
          </button>
        </div>
        ...
        <div class="p-4 border-b border-border">
          ...
          <button
            ...
            disabled={props.busy}
            class="w-full text-left text-xs text-accent hover:bg-toast-error-bg bg-transparent border-none cursor-pointer py-2 px-2 transition-colors disabled:cursor-not-allowed disabled:opacity-60"
          >
            Delete
          </button>
          <button
      ...
      <div class="p-4 border-t border-border flex-shrink-0">
        ...
        <button
          ...
          disabled={props.busy}
          class="w-full bg-accent text-white text-micro uppercase tracking-label font-semibold py-3 border-none cursor-pointer hover:bg-primary transition-colors disabled:cursor-not-allowed disabled:opacity-60"
        >
